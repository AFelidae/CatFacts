...
static FACTS: [&str;102] = [//Cat facts from: https://cvillecatcare.com/veterinary-topics/101-amazing-cat-facts-fun-trivia-about-your-feline-friend/
    ...
    "Grapes and raisins, as well as onions, garlic, and chives, are all extremely harmful foods for cats. Grapes and raisins can cause kidney failure — although the reasoning behind that isn’t clear. Meanwhile, onions, garlic, and chives wreak havoc on your cat’s gastrointestinal system and can cause anemi",
...
fn main() {
    ...
    loop {
        ...
        ctx.set_contents(FACTS[i].to_owned());
    }
}
